...
if (file_exists('img/1.png')) {
    $pdf->Image('img/1.png', 10, 10, 20);  // Reducir tamaño del logo
}

// Información de la empresa
$pdf->SetXY(40, 10);
$pdf->MultiCell(0, 5, "Nombre de la Empresa\nDireccion de la Empresa\nTelefono: +123456789\nEmail: info@empresa.com", 0, 'L');

// Información del cliente
$pdf->SetXY(130, 10);
$pdf->SetFont('Arial', 'B', 10);  // Reducir tamaño de fuente
$pdf->Cell(0, 5, 'Informacion del Cliente:', 0, 1);
...
$pdf->SetXY(10, 40);
$pdf->SetFont('Arial', 'B', 14);  // Reducir tamaño de fuente del título
$pdf->Cell(0, 10, 'COTIZACION', 0, 1, 'C');
$pdf->Ln(3);

// Información de la cotización en tabla
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(30, 8, 'ID Cotizacion', 1);
$pdf->Cell(50, 8, 'Descripcion', 1);
$pdf->Cell(30, 8, 'Monto', 1);
$pdf->Cell(30, 8, 'Fecha', 1);
$pdf->Cell(30, 8, 'Vigencia', 1);
$pdf->Ln();

$pdf->SetFont('Arial', '', 9);  // Reducir tamaño de fuente
$pdf->Cell(30, 8, $cotizacion['ID_Cotizacion'], 1);
$pdf->Cell(50, 8, $cotizacion['Descripcion'], 1);
$pdf->Cell(30, 8, '$' . number_format($cotizacion['Monto'], 2), 1);
$pdf->Cell(30, 8, $cotizacion['Fecha'], 1);
$pdf->Cell(30, 8, $cotizacion['Vigencia'], 1);
$pdf->Ln();

// Añadir más detalles si es necesario
$pdf->Cell(40, 8, 'Punto de Origen', 1);
$pdf->Cell(60, 8, 'Punto de Destino', 1);
$pdf->Cell(30, 8, 'Fecha de Traslado', 1);
$pdf->Ln();
$pdf->Cell(40, 8, $cotizacion['PuntoA_Origen'], 1);
$pdf->Cell(60, 8, $cotizacion['PuntoB_Destino'], 1);
$pdf->Cell(30, 8, $cotizacion['Fecha_Traslado'], 1);
$pdf->Ln();

// Cláusulas importantes
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(0, 8, 'Clausulas importantes:', 0, 1);
$pdf->SetFont('Arial', '', 8);  // Reducir tamaño de fuente para las cláusulas
$clausulas = [
...
foreach ($clausulas as $clausula) {
    $pdf->MultiCell(0, 4, utf8_decode($clausula), 0, 'L');  // Reducir el espacio entre líneas
}
